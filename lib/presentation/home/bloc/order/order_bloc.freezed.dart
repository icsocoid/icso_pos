...
class _$ErrorImpl implements _Error {
  const _$ErrorImpl(this.messager);
  ...
  @override
  String toString() {
    return 'OrderState.error(messager: $messager)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, messager);
...
abstract class _Error implements OrderState {
  const factory _Error(final String messager) = _$ErrorImpl;
